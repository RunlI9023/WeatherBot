...
@Component
public class ForecastForCityName {
    ...
    public ForecastForCityName() {
    }

    public ForecastForCityName(String cod, Integer message, Integer cnt, java.util.List<ListForecastForCityName> list, CityForecastForCityName city) {
        this.cod = cod;
