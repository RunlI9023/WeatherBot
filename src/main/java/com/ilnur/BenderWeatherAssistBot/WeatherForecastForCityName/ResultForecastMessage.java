...
@Component
public class ResultForecastMessage {
    ...
    public ResultForecastMessage() {
    }

    public ResultForecastMessage(String Date, String Description, Double TempMaximum, Double TempMinimum, Double TempFeelsLike, Integer Humidity, Integer Pressure, Integer Visibility, Integer Clouds, Double WindSpeed) {
        this.Date = Date;
